...
art1 = Artwork.create!( title: "Trees of Cotton Candy", image_url: "uhehvveve", artist_id: user1.id )
art2 = Artwork.create!( title: "Kittyans Jones and the repurrrsion of Death", image_url: "uhehvveve", artist_id: user2.id )
art3 = Artwork.create!( title: "What's Covid got to do with it?", image_url: "uhehvveve", artist_id: user3.id )
art4 = Artwork.create!( title: "That's my purse, I don't know know you", image_url: "uhehvveve", artist_id: user4.id )
